    ...
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                entity.Property(e => e.CreatedOn).HasColumnName("createdon");
                entity.Property(e => e.UpdatedOn).HasColumnName("updatedon");
                // Note: IsInStock and IsLowInStock are computed properties (=> expression) - excluded from mapping
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.Property(e => e.CreatedOn).HasColumnName("createdon");
                entity.Property(e => e.UpdatedOn).HasColumnName("updatedon");
                // Note: FullName is a computed property (=> expression) - excluded from mapping
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.CreatedOn).HasColumnName("createdon");
                entity.Property(e => e.UpdatedOn).HasColumnName("updatedon");
                // Note: Tax and Total are computed properties (=> expression) - excluded from mapping
